...
public class Agunan implements Serializable {
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, targetEntity = Append_plotting.class)
	@JoinColumn(name = "id_agunan", referencedColumnName = "urut", insertable = false, updatable = false)
	private List<Append_plotting> append_plotting;
	
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, targetEntity = Append_taksasi.class)
	@JoinColumn(name = "id_agunan", referencedColumnName = "urut", insertable = false, updatable = false)
	private List<Append_taksasi> append_taksasi;
	...
	public List<Append_plotting> getAppend_plotting() {
		return append_plotting;
	}

	public void setAppend_plotting(List<Append_plotting> append_plotting) {
		this.append_plotting = append_plotting;
	}

	public List<Append_taksasi> getAppend_taksasi() {
		return append_taksasi;
	}

	public void setAppend_taksasi(List<Append_taksasi> append_taksasi) {
		this.append_taksasi = append_taksasi;
	}
