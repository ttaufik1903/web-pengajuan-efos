...
@Entity
@Table(name = "view_realisasi_cabang")
public class Realisasi_cabang_detail {
	...
	private String baki_debet_lama;
	private String nik_ao;
	...
	public String getBaki_debet_lama() {
		return baki_debet_lama;
	}
	public void setBaki_debet_lama(String baki_debet_lama) {
		this.baki_debet_lama = baki_debet_lama;
	}
	public String getNik_ao() {
		return nik_ao;
	}
	public void setNik_ao(String nik_ao) {
		this.nik_ao = nik_ao;
	}
