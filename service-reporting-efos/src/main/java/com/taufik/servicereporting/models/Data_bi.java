...
public class Data_bi implements Serializable {
	...
	private Integer program_pemerintah;
...
//	}
	...
	public Integer getProgram_pemerintah() {
	...
	public void setProgram_pemerintah(String program_pemerintah) {
		if (program_pemerintah.equals("") || program_pemerintah.equals("null")) {
			...
			this.program_pemerintah = Integer.valueOf(program_pemerintah);
		}
	}
	...
	public Double getBagian_dijamin() {
		return bagian_dijamin;
	}

	public void setBagian_dijamin(String bagian_dijamin) {
		if (bagian_dijamin.equals("") || bagian_dijamin.equals("null")) {
			this.bagian_dijamin = null;
		} else {
			this.bagian_dijamin = Double.valueOf(bagian_dijamin);
		}
	}
