...
import com.taufik.servicereporting.models.Data_bi;
...
//	private Integer id_plan;
	...
	@JsonProperty("Plan")
	public HashMap<String, String> get_detailplan() {
		HashMap<String, String> plan = new HashMap<String, String>();
		plan.put("kode_plan", par_plan.getId().toString());
		plan.put("nama_plan", par_plan.getName());
		plan.put("akad", par_plan.getNama_akad());
	...
	private Par_cabang par_cabang;

	@JsonProperty("Cabang")
	public HashMap<String, String> genama_cabangs() {
		HashMap<String, String> cabang = new HashMap<String, String>();
		cabang.put("kode_cabang", par_cabang.getId());
		cabang.put("nama_cabang", par_cabang.getCabang());
		cabang.put("kode_cabang_induk", par_cabang.getCab_induk());
		cabang.put("nama_cabang_induk", par_cabang.getCabanginduk().getCabang());

		return cabang;
	}

	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "kode_referal")
	private Par_kode_referal par_kode_referal;

	@OneToOne
	@JoinColumn(name = "id", referencedColumnName = "id_loan")
	private M_data_bi databi;

	@OneToOne
	@JoinColumn(name = "id_debitur", referencedColumnName = "id")
	private M_data_debitur debitur;

	@JsonProperty("M_data_debitur")
	public HashMap<String, String> getDebitur() {
		HashMap<String, String> debiturs = new HashMap<String, String>();
		debiturs.put("id_ktp", debitur.getId());
		debiturs.put("nama", debitur.getNama());
		debiturs.put("tgl_lahir", debitur.getTgl_lahir().toString());
		debiturs.put("alamat", debitur.getAlamat());
		debiturs.put("cif", debitur.getCif());
		debiturs.put("nomor_hp", debitur.getNo_telp());
		return debiturs;
	}
...
//	}
	...
	public Long getPlafon_disetujui() {
		return plafon_disetujui.longValue();
	}
	...
	public Par_cabang getPar_cabang() {
		return par_cabang;
	}


	public void setPar_cabang(Par_cabang par_cabang) {
		this.par_cabang = par_cabang;
	}



	public M_data_bi getDatabi() {
		return databi;
	}


	public void setDatabi(M_data_bi databi) {
		this.databi = databi;
	}


	public Par_plan getPar_plan() {
		return par_plan;
	}
