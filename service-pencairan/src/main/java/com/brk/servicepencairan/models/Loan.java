...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
	...
	private BigInteger norek_pencairan;
	...
	private String rekomendasi_pinbag;
	private Double baki_debet_lama;
	

	// PARENT PAR par_agunan_basel2_jenis_agunan
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "kode_aset_ijarah", insertable = false, updatable = false)
	private Par_kode_aset_ijarah desc_kode_aset_ijarah;

	@JsonProperty("desc_kode_aset_ijarah")
	public String getPar_kode_aset_iajarah() {
		if (desc_kode_aset_ijarah == null) {
			return "";
		} else {
			return desc_kode_aset_ijarah.getName();
		}
	}
	
	// PARENT PAR par_agunan_basel2_jenis_agunan
		@ManyToOne(fetch = FetchType.LAZY)
		@JoinColumn(name = "take_over_nama_bank", insertable = false, updatable = false)
		private Par_bv_takeover_dari desc_take_over_dari;

		@JsonProperty("desc_take_over_dari")
		public String getPar_bv_take_over_dari() {
			if (desc_take_over_dari == null) {
				return "";
			} else {
				return desc_take_over_dari.getKeterangan();
			}
		}
...
//	}
	...
	public BigInteger getNorek_pencairan() {
		return norek_pencairan;
	}

	public void setNorek_pencairan(BigInteger norek_pencairan) {
	...
	public String getRekomendasi_pinbag() {
		return rekomendasi_pinbag;
	}

	public void setRekomendasi_pinbag(String rekomendasi_pinbag) {
		this.rekomendasi_pinbag = rekomendasi_pinbag;
	}
