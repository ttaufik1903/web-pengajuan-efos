...
import com.brk.servicepencairan.models.Par_agama;
import com.brk.servicepencairan.models.Par_dati2;
import com.brk.servicepencairan.models.Par_kebangsaan;
import com.brk.servicepencairan.models.Par_kec;
import com.brk.servicepencairan.models.Par_kel;
import com.brk.servicepencairan.models.Par_kelamin;
import com.brk.servicepencairan.models.Par_pendidikan;
import com.brk.servicepencairan.models.Par_provinsi;
import com.brk.servicepencairan.models.Par_status;
import com.brk.servicepencairan.models.Par_tempat_tinggal;
...
//    @GeneratedValue(strategy = GenerationType.IDENTITY)
	...
	public M_data_debitur() {
		super();
	}
	
	public M_data_debitur (String id, String cif,String nama, String npwp, String alamat, Integer kelamin, String tmp_lahir, LocalDate tgl_lahir, String golongan_deb) {
		this.id=id;
		this.cif=cif;
		this.nama=nama;
		this.npwp=npwp;
...
//	@OneToMany(fetch = FetchType.LAZY, mappedBy = "id_debitur")
