...
import com.brk.servicepencairan.models.Par_qaca_detail;
import com.brk.servicepencairan.models.Qaca_data_id;
import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import com.fasterxml.jackson.annotation.JsonProperty;
@Entity
@Table(name = "m_qaca_data")
@IdClass(Qaca_data_id.class)
public class M_qaca_data implements Serializable{
