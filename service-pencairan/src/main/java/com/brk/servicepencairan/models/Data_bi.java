...
@Entity
@Table(name = "data_bi", schema = "pelaporan")
public class Data_bi implements Serializable {
...
//	private Double plafon;
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "kode_sektor_ekonomi_bi", insertable = false, updatable = false, nullable = true)
	private Par_kode_sektor_ekonomi_bi par_kode_sektor_ekonomi_bi;

	@JsonProperty("kode_akad")
	public String getKode_akad() {
		if (par_kode_sektor_ekonomi_bi == null) {
			return "";
		} else {
			return par_kode_sektor_ekonomi_bi.getKode_akad();
		}
	}
...
//	}
	...
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "jenis_penggunaan_bi", insertable = false, updatable = false, nullable = true)
	private Par_jenis_penggunaan_bi par_jenis_penggunaan_bi;

	@JsonProperty("desc_jenis_penggunaan_bi")
	public String getDesc_jenis_penggunaan_bi() {
		if (par_jenis_penggunaan_bi == null) {
			return "";
		} else {
			return par_jenis_penggunaan_bi.getName();
		}
	}
	...
	public void setSifat_pembiayaan(String sifat_pembiayaan) {
		if (sifat_pembiayaan.equals("") || sifat_pembiayaan.equals("null")) {
			this.sifat_pembiayaan = null;
		} else {
			this.sifat_pembiayaan = Integer.valueOf(sifat_pembiayaan);
		}
	}
	...
	public void setOrientasi_penggunaan(String orientasi_penggunaan) {
		if (orientasi_penggunaan.equals("") || orientasi_penggunaan.equals("null")) {
			this.orientasi_penggunaan = null;
		} else {
			this.orientasi_penggunaan = Integer.valueOf(orientasi_penggunaan);
		}
	}

	public BigInteger getJenis_valuta() {
		return jenis_valuta;
	}

	public void setJenis_valuta(String jenis_valuta) {
		if (jenis_valuta.equals("") || jenis_valuta.equals("null")) {
			this.jenis_valuta = null;
		} else {
			this.jenis_valuta = new BigInteger(jenis_valuta);
		}
	}
	...
	public void setProgram_pemerintah(String program_pemerintah) {
		if (program_pemerintah.equals("") || program_pemerintah.equals("null")) {
			this.program_pemerintah = null;
		} else {
	...
	public void setHarga_perolehan_aset(String harga_perolehan_aset) {
		if (harga_perolehan_aset.equals("") || harga_perolehan_aset.equals("null")) {
			this.harga_perolehan_aset = null;
		} else {
			this.harga_perolehan_aset = Double.valueOf(harga_perolehan_aset);
		}
	}
	...
	public void setJumlah_amortisasi(String jumlah_amortisasi) {
		if (jumlah_amortisasi.equals("") || jumlah_amortisasi.equals("null")) {
			this.jumlah_amortisasi = null;
		} else {
			this.jumlah_amortisasi = Double.valueOf(jumlah_amortisasi);
		}
	}
	...
	public void setAmortisasi(String amortisasi) {
		if (amortisasi.equals("") || amortisasi.equals("null")) {
			this.amortisasi = null;
		} else {
			this.amortisasi = Integer.valueOf(amortisasi);
		}
	}
	...
	public void setJenis_suku_imbalan(String jenis_suku_imbalan) {
		if (jenis_suku_imbalan.equals("") || jenis_suku_imbalan.equals("null")) {
			this.jenis_suku_imbalan = null;
		} else {
			this.jenis_suku_imbalan = Integer.valueOf(jenis_suku_imbalan);
		}
	}
	...
	public void setPersentase_imbalan_awal_kontrak(String persentase_imbalan_awal_kontrak) {
		if (persentase_imbalan_awal_kontrak.equals("") || persentase_imbalan_awal_kontrak.equals("null")) {
			this.persentase_imbalan_awal_kontrak = null;
		} else {
			this.persentase_imbalan_awal_kontrak = Double.valueOf(persentase_imbalan_awal_kontrak);
		}
	}

	public Double getPersentase_imbalan_bulan_laporan() {
		return persentase_imbalan_bulan_laporan;
	}

	public void setPersentase_imbalan_bulan_laporan(String persentase_imbalan_bulan_laporan) {
		if (persentase_imbalan_bulan_laporan.equals("") || persentase_imbalan_bulan_laporan.equals("null")) {
			this.persentase_imbalan_bulan_laporan = null;
		} else {
			this.persentase_imbalan_bulan_laporan = Double.valueOf(persentase_imbalan_bulan_laporan);
		}
	}
