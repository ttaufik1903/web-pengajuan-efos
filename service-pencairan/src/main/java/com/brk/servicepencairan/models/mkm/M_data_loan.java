...
import com.brk.servicepencairan.models.MScoringLoan;
import com.brk.servicepencairan.models.Par_asu;
import com.brk.servicepencairan.models.Par_bidang_usaha;
import com.brk.servicepencairan.models.Par_broker;
import com.brk.servicepencairan.models.Par_cabang;
import com.brk.servicepencairan.models.Par_kategori_produk;
import com.brk.servicepencairan.models.Par_kode_margin;
import com.brk.servicepencairan.models.Par_plan;
import com.brk.servicepencairan.models.Par_qaca_data;
import com.brk.servicepencairan.models.Par_status_perusahaan;
...
@Entity
@Table(name = "m_data_loan")
public class M_data_loan implements Serializable {
	...
	private String rahn_nomor;
	private LocalDate rahn_tgl_awal;
	private LocalDate rahn_tgl_akhir;
	private Integer rahn_jumlah_bulan;
	private String rahn_keterangan;
	private String rahn_nama_barang;
	private Integer rahn_jumlah;
	private Double rahn_harga_dasar;
	private Double rahn_taksiran;
	private Double rahn_persen_pembiayaan;
	private Double rahn_max_pembiayaan;
	private Double rahn_ujroh;
	...
	private String norek_urbun;
	private String nama_rekening_urbun;
	private String kode_rekening_urbun;
	...
	public M_data_loan (String id, String id_cab, LocalDateTime tgl_pengajuan, String id_debitur, Integer id_neraca, Integer id_wallet, String kategori_template, 
			String status, Double caoi, String created_by, String created_nama, LocalDateTime created_date, Double pcda, String tujuan_pembiayaan, 
			Integer id_kategori_produk, Integer id_plan, String frequensi_pembayaran_margin, Integer frequensi_pembayaran_number, Double harga_perolehan,
			Double pajak, Double diskon, Double plafon_pengajuan, Double uang_muka, Integer tenor_pengajuan, String kode_margin, BigDecimal margin_pengajuan, 
			Float basis_point_margin, String basis_point_margin_mark, Float exp_rate, Double nisbah_bank, Double nisbah_nasabah, Double angsuran_pengajuan, 
			Integer grace_period,Integer id_template_dokumen, Integer hubungan_bank, String norek, String nama_bank, String atas_nama ) {
		this.id=id;
		this.id_cab=id_cab;
	...
	@JoinColumn(name = "ud_bidang_usaha", insertable = false, updatable = false)
	private Par_bidang_usaha desc_ud_bidang_usaha;

	@JsonProperty("desc_ud_bidang_usaha")
	public String getPar_bidang_usaha() {
		if (desc_ud_bidang_usaha == null) {
			return "";
		} else {
			return desc_ud_bidang_usaha.getName();
		}
	}
	
	@ManyToOne(fetch = FetchType.LAZY)
	@JoinColumn(name = "ud_status_tempat_usaha", insertable = false, updatable = false)
	private Par_status_perusahaan desc_ud_status_tempat_usaha;

	@JsonProperty("desc_ud_status_tempat_usaha")
	public String getPar_status_perusahaan() {
		if (desc_ud_status_tempat_usaha == null) {
			return "";
		} else {
			return desc_ud_status_tempat_usaha.getName();
		}
	}
	...
	@JsonProperty("nilai_margin")
	public BigDecimal getNilai_margin() {
		if (desc_kode_margin == null) {
			return new BigDecimal(0);
		} else {
			return desc_kode_margin.getNilai();
		}
	}
	...
	@OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, targetEntity = Par_qaca_data.class)
	@JoinColumn(name = "id_loan", referencedColumnName = "id", insertable = false, updatable = false)
	private List<Par_qaca_data> par_qaca_data;
...
//	}
	...
	public List<Par_qaca_data> getPar_qaca_data() {
		return par_qaca_data;
	}

	public void setPar_qaca_data(List<Par_qaca_data> par_qaca_data) {
		this.par_qaca_data = par_qaca_data;
	}
...
//	}
	...
	public String getRahn_nomor() {
		return rahn_nomor;
	}

	public void setRahn_nomor(String rahn_nomor) {
		this.rahn_nomor = rahn_nomor;
	}

	public LocalDate getRahn_tgl_awal() {
		return rahn_tgl_awal;
	}

	public void setRahn_tgl_awal(LocalDate rahn_tgl_awal) {
		this.rahn_tgl_awal = rahn_tgl_awal;
	}

	public LocalDate getRahn_tgl_akhir() {
		return rahn_tgl_akhir;
	}

	public void setRahn_tgl_akhir(LocalDate rahn_tgl_akhir) {
		this.rahn_tgl_akhir = rahn_tgl_akhir;
	}

	public Integer getRahn_jumlah_bulan() {
		return rahn_jumlah_bulan;
	}

	public void setRahn_jumlah_bulan(Integer rahn_jumlah_bulan) {
		this.rahn_jumlah_bulan = rahn_jumlah_bulan;
	}

	public String getRahn_keterangan() {
		return rahn_keterangan;
	}

	public void setRahn_keterangan(String rahn_keterangan) {
		this.rahn_keterangan = rahn_keterangan;
	}

	public String getRahn_nama_barang() {
		return rahn_nama_barang;
	}

	public void setRahn_nama_barang(String rahn_nama_barang) {
		this.rahn_nama_barang = rahn_nama_barang;
	}

	public Integer getRahn_jumlah() {
		return rahn_jumlah;
	}

	public void setRahn_jumlah(Integer rahn_jumlah) {
		this.rahn_jumlah = rahn_jumlah;
	}

	public Double getRahn_harga_dasar() {
		return rahn_harga_dasar;
	}

	public void setRahn_harga_dasar(Double rahn_harga_dasar) {
		this.rahn_harga_dasar = rahn_harga_dasar;
	}

	public Double getRahn_taksiran() {
		return rahn_taksiran;
	}

	public void setRahn_taksiran(Double rahn_taksiran) {
		this.rahn_taksiran = rahn_taksiran;
	}

	public Double getRahn_persen_pembiayaan() {
		return rahn_persen_pembiayaan;
	}

	public void setRahn_persen_pembiayaan(Double rahn_persen_pembiayaan) {
		this.rahn_persen_pembiayaan = rahn_persen_pembiayaan;
	}

	public Double getRahn_max_pembiayaan() {
		return rahn_max_pembiayaan;
	}

	public void setRahn_max_pembiayaan(Double rahn_max_pembiayaan) {
		this.rahn_max_pembiayaan = rahn_max_pembiayaan;
	}

	public Double getRahn_ujroh() {
		return rahn_ujroh;
	}

	public void setRahn_ujroh(Double rahn_ujroh) {
		this.rahn_ujroh = rahn_ujroh;
	}

	public String getNorek_urbun() {
		return norek_urbun;
	}

	public void setNorek_urbun(String norek_urbun) {
		this.norek_urbun = norek_urbun;
	}

	public String getNama_rekening_urbun() {
		return nama_rekening_urbun;
	}

	public void setNama_rekening_urbun(String nama_rekening_urbun) {
		this.nama_rekening_urbun = nama_rekening_urbun;
	}

	public String getKode_rekening_urbun() {
		return kode_rekening_urbun;
	}

	public void setKode_rekening_urbun(String kode_rekening_urbun) {
		this.kode_rekening_urbun = kode_rekening_urbun;
	}
