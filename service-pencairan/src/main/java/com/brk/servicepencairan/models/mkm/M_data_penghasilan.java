...
import com.brk.servicepencairan.models.Par_dinas;
import com.brk.servicepencairan.models.Par_profesi;
import com.brk.servicepencairan.models.Par_status_perusahaan;
import com.brk.servicepencairan.models.Par_sub_dinas;
...
//			@JoinColumn(name = "cab_open", referencedColumnName = "id_cabang", insertable = false, updatable = false) })
	...
	@JsonProperty("sub_sub_dinas")
	public String getSub_sub_dinas() {
		if (desc_sub_sub_dinas == null) {
			return "";
		} else {
			return desc_sub_sub_dinas.getId_sub_sub_dinas();
		}
	}
