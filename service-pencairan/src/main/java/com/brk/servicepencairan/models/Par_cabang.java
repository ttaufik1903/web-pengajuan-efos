...
//	@GeneratedValue(strategy = GenerationType.IDENTITY)
	...
	private String nama_pimpinan;
	private String tempat_lahir_pimpinan;
	private String tanggal_lahir_pimpinan;
	private String alamat_pimpinan;
	private String no_ktp_pimpinan;
	...
	public String getTempat_lahir_pimpinan() {
		return tempat_lahir_pimpinan;
	}
	public void setTempat_lahir_pimpinan(String tempat_lahir_pimpinan) {
		this.tempat_lahir_pimpinan = tempat_lahir_pimpinan;
	}
	public String getTanggal_lahir_pimpinan() {
		return tanggal_lahir_pimpinan;
	}
	public void setTanggal_lahir_pimpinan(String tanggal_lahir_pimpinan) {
		this.tanggal_lahir_pimpinan = tanggal_lahir_pimpinan;
	}
	public String getAlamat_pimpinan() {
		return alamat_pimpinan;
	}
	public void setAlamat_pimpinan(String alamat_pimpinan) {
		this.alamat_pimpinan = alamat_pimpinan;
	}
	public String getNo_ktp_pimpinan() {
		return no_ktp_pimpinan;
	}
	public void setNo_ktp_pimpinan(String no_ktp_pimpinan) {
		this.no_ktp_pimpinan = no_ktp_pimpinan;
	}
