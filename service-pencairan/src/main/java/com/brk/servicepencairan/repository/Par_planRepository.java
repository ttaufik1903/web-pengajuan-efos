...
public interface Par_planRepository extends JpaRepository<Par_plan, Integer> {
    ...
    @Query(value = "SELECT * FROM par_plan WHERE \"id_sub_produk\"=:id_sub_produk", nativeQuery = true)
    List<Par_plan> findByIdSubProduk(@Param("id_sub_produk") Integer id_sub_produk);
