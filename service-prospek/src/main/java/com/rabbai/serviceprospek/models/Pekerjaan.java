...
public class Pekerjaan implements Serializable {
	...
	private String kategori_usaha;
	private String alamat;
	private String kode_post;
	private Double b_operasional;
	private Double b_gaji;
	private Double kewajiban_tetap;
	private Double kewajiban_lainnya;
	...
	public void setKategori_usaha(String kategori_usaha) {
		this.kategori_usaha = kategori_usaha;
	}
	...
	public Double getKewajiban_tetap() {
		return kewajiban_tetap;
	}

	public void setKewajiban_tetap(Double kewajiban_tetap) {
		this.kewajiban_tetap = kewajiban_tetap;
	}

	public Double getKewajiban_lainnya() {
		return kewajiban_lainnya;
	}

	public void setKewajiban_lainnya(Double kewajiban_lainnya) {
		this.kewajiban_lainnya = kewajiban_lainnya;
	}
